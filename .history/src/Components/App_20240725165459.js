...
function App() {
  ...
  const [editcontact, editcontact] = useState([]);
  ...
  return (
    ...
    <Router>
      ...
      <Routes>
          ...
          <Route path="/edit" exact element={<ContactDetails contact={contact} setContact={setContact} local_storage_key={local_storage_key}/>}/>         
      </Routes>
    </Router>
    </div>
  );
