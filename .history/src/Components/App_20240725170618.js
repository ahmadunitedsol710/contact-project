  ...
  return (
    ...
    <Router>
      ...
      <Routes>
          ...
          <Route path="/edit" exact element={<ContactDetails contact={contact} seteditcontact={seteditcontact} editcontact={}  setContact={setContact} local_storage_key={local_storage_key}/>}/>         
      </Routes>
    </Router>
    </div>
  );
