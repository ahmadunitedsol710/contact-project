...
const ContactCard = (props) => {
    const [show, setcontact]=useState(false);
                        ...
                        <tr>
                            ...
                            <td className='align-content-center' data-label="Action"> 
                                <i class="bi bi-trash3" style={{ color: "red", marginTop: "7px" }} onClick={() => props.clickHandler(item.id)}></i>
                                 <Link to="/edit" onClick={clickhadler(item.id)}>  <i class="bi bi-pencil-square"  style={{ color: "green", marginTop: "7px", marginLeft: "7px" }} ></i> </Link>
                            </td>
                        </tr>
                )}
            </tbody>
