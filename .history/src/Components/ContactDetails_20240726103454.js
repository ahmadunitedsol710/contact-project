...
function ContactDetails({ contact, updateContactHandler }) {
    ...
    const [formData, setFormData] = useState({ fname:contactToEdit.fname, lname:contactToEdit.lname, email: contactToEdit, city:contactToEdit, postal:contactToEdit, number:contactToEdit  });
