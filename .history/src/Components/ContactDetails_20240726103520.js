...
function ContactDetails({ contact, updateContactHandler }) {
    ...
    const [formData, setFormData] = useState({ fname:contactToEdit.fname, lname:contactToEdit.lname, email: contactToEdit.email, city:contactToEdit.city, postal:contactToEdit.postal, number:contactToEdit  });
