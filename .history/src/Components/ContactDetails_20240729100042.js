...
function ContactDetails({ contact, updateContactHandler }) {
    ...
    const [formData, setFormData] = useState({ fname:contactToEdit.fname, lname:contactToEdit.lname, email: contactToEdit.email, country: con city:contactToEdit.city, postal:contactToEdit.postal, number:contactToEdit.number  });
