...
function ContactDetails({ contact, updateContactHandler }) {
    ...
    const [formData, setFormData] = useState({ fname:contactToEdit.fname, lname:contactToEdit.lname, email: contactToEdit.email, country: contactToEdit.country, city:contactToEdit.city, postal:contactToEdit.postal, number:contactToEdit.number  });
            ...
            <form>
                ...
                <div className="row">
                    ...
                    <div className="col-sm-6">
                        ...
                        <select className="form-select" name='provice' value={formData.province} onChange={changeField}>
