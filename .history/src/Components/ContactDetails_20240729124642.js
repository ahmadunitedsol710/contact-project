...
function ContactDetails({ contact, updateContactHandler }) {
    ...
    const [formData, setFormData] = useState({ fname:contactToEdit.fname, lname:contactToEdit.lname, email: contactToEdit.email, country: contactToEdit.country, city:contactToEdit.city, province: contactToEdit.pro  postal:contactToEdit.postal, number:contactToEdit.number  });
